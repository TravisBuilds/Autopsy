...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(() => {
    ...
    if (err === "auth_callback") return "Sign-in link expired or invalid. Try again.";
    return null;
  });
  ...
  const safeNext =
    nextPath?.startsWith("/") && !nextPath.startsWith("/login") ? nextPath : "/";
  ...
  return (
    <AuthShell title={mode === "signin" ? "Sign in" : "Create account"}>
